...
class Dataloader:
    def __init__(self):
        ...
        # creating instances of image data generator for loading training and testing images
        ...
        self.logger.info('Created ImageDataGenerator instance for test data generator')

        # loading the training set 
        self.training_set = self.train_datagenerator.flow_from_directory(
            'Images/train',
            target_size=(224, 224),
            batch_size=16,
        ...
        self.test_set = self.test_datagenerator.flow_from_directory(
            'Images/test',
            target_size=(224, 224),
            batch_size=16,
            class_mode='categorical')
